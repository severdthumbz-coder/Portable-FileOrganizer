...
namespace FileOrganizer
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            // Give the ViewModel a handle to the banner control so it can raise notifications.
            if (DataContext is ViewModels.MainViewModel viewModel)
            {
                viewModel.SetBannerNotification(CompletionBanner);
            }
        }
        ...
        private void UpdateThemeIcon()
        {
            if (_isDarkMode)
            {
                // Sun icon (click to return to light mode)
        ...
        // NOTE: RemoveSelectedSourceFolders_Click moved to Views/ConfigurationTabView.xaml.cs
        //       RemoveSelectedExceptions_Click  moved to Views/ExceptionsTabView.xaml.cs
        //       Their DataGrids now live in those UserControls.
    }
}
